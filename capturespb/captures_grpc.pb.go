...
func (c *captureServiceClient) GetHCNLogs(ctx context.Context, in *HCNRequest, opts ...grpc.CallOption) (*HCNResponse, error) {
	out := new(HCNResponse)
	err := c.cc.Invoke(ctx, "/captures.CaptureService/GetHCNLogs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCaptureServiceServer) GetHCNLogs(context.Context, *HCNRequest) (*HCNResponse, error) {
...
func _CaptureService_GetHCNLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HCNRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CaptureServiceServer).GetHCNLogs(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/captures.CaptureService/GetHCNLogs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaptureServiceServer).GetHCNLogs(ctx, req.(*HCNRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CaptureService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CaptureService_GetHCNLogs_Handler,
		},
	},
